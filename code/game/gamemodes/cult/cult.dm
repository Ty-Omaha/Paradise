...
/datum/game_mode/cult
	name = "cult"
	config_tag = "cult"
	restricted_jobs = list("Customs Agent", "Chaplain","AI", "Cyborg", "Internal Affairs Agent", "Security Officer", "Warden", "Detective", "Security Pod Pilot", "Head of Security", "Captain", "Head of Personnel", "Blueshield", "Nanotrasen Representative", "Magistrate", "Brig Physician", "Nanotrasen Navy Officer", "Special Operations Officer", "Syndicate Officer")
	protected_jobs = list()
	required_players = 30
	required_enemies = 3
